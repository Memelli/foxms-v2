...
{/*                 <h1 className="drop-shadow-md text-white lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14">
                ...
                <Link to="/" className="py-6 px-10 bg-purple-800 rounded-full text-white text-3xl hover:bg-purple-500 transition duration-300 ease-in-out flex items-center animate-bounce">
                    JOGUE AGORA!
